...
namespace gazebo {
// Default values
    math::Vector3 geo_vector3_to_math_vector3_convert(geometry_msgs::Vector3 _vector);

    static const std::string kDefaultNamespace = "";
    static const std::string kDefaultWindPubTopic = "/wind_wrench";
    static const std::string kDefaultFrameId = "world";
    static const std::string kDefaultLinkName = "base_link";

    static const double kDefaultWindForceMean = 0.0;
    static const double kDefaultWindForceVariance = 0.0;
    static const double kDefaultWindGustForceMean = 0.0;
    static const double kDefaultWindGustForceVariance = 0.0;

//    geometry_msgs::Vector3 DefaultWindDirection;
    ...
    static const double kDefaultWindGustStart = 10.0;
    static const double kDefaultWindGustDuration = 0.0;
    ...
    protected:
        ...
        /// \callback function to subscribe wind gust
        ///
        void Callback(const auto_takeoff::WindGust &_wind_gust);
